...
do
	...
	expression_RDS=./input/test_exp_matrix_comb.RDS
	geno_file=./input/test_genotype_matrix_chr${chrom}.txt
	gene_annot_RDS=./input/gencode.v26lift37.annotation.gene.only.parsed.RDS
	snp_annot_RDS=./input/test_snp_annot.chr${chrom}.RDS
	covariates_file=NA
	gene_snps_RDS=./input/snp-gene_pairs/GM12878_newABC_sig_snplist_1mb.RDS	        
